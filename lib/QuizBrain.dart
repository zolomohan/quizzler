...
class QuizBrain {
  ...
  bool isAnswer(bool userAnswer) => _questionBank[_questionNumber].answer == userAnswer;

  void nextQuestion() =>
      _questionNumber < _questionBank.length - 1 ? _questionNumber++ : null;

  bool isFinalQuestion() => _questionNumber == _questionBank.length - 1;
